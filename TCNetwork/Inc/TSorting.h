 ...
 * @file	TSorting.h
 *
 * Declares the sorting class.
 */
#ifndef __TSORTING_H__
#define __TSORTING_H__
...
/**
 * Sort elements. The sort is unstable, meaning that the ordering of equal items
...
void Sort( T* First, INT Num )
{
	...
	NStack RecursionStack[32] = { { First, First + Num - 1 } }, Current, Inner;
	for ( NStack* StackTop = RecursionStack; StackTop >= RecursionStack; --StackTop )
	{
		Current = *StackTop;
